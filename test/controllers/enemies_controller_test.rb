...
class EnemiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enemy" do
    assert_difference("Enemy.count") do
      post enemies_url, params: { enemy: { date_of_enemy: @enemy.date_of_enemy, email: @enemy.email, name: @enemy.name, phone: @enemy.phone, years: @enemy.years } }
    end
  ...
  test "should update enemy" do
    patch enemy_url(@enemy), params: { enemy: { date_of_enemy: @enemy.date_of_enemy, email: @enemy.email, name: @enemy.name, phone: @enemy.phone, years: @enemy.years } }
